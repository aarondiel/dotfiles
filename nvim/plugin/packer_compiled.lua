...
_G.packer_plugins = {
  ...
  ["cmp-calc"] = {
    loaded = true,
    path = "/home/aaron/.local/share/nvim/site/pack/packer/start/cmp-calc",
  ...
  ["feline.nvim"] = {
    ...
    loaded = true,
    path = "/home/aaron/.local/share/nvim/site/pack/packer/start/feline.nvim",
  ...
  playground = {
    loaded = true,
    path = "/home/aaron/.local/share/nvim/site/pack/packer/start/playground",
