...
local global_keys = {
	...
	{ { modkey, 'w' }, utils.change_wallpapers, 'update wallpapers', 'general' },
	...
	{ { 'XF86MonBrightnessDown' }, utils.change_brightness(-1), 'decrease monitor brightness', 'audio' },
	{ { 'XF86MonBrightnessUp' }, utils.change_brightness(1), 'increase monitor brightness', 'audio' }
}
